...
% train an xgboost model See "C:\cpcardio\physionet_2020\call_xgboost.m", "C:\r\xgboost\py\ex_xgboost.py"
...
%%% Steps to compile xgboost library and use it in Matlab:
    ...
    %   - make folder C:\r\xgboost (e.g.)
    %   - create an empty git repository 
    %   - pull from https://github.com/dmlc/xgboost
    % 	- Git bash here (C:\r\xgboost) - open a git bash. In it type:
    % 	- git submodule init
    ...
    %   - In dos, go to folder C:\r\xgboost. In it execute:
    % 		mkdir build
    % 		cd build
...
%%% default in "C:\g\py\hot\postprob\postprob.py", "C:\r\xgboost\py\ex_xgboost.py":
% if isempty(params)
